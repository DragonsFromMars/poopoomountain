...
export function EmailSignupForm({ source, title, buttonText }: { source: string; title: string; buttonText: string }) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bangers mb-4 text-center text-amber-900">{title}</h2>
      ...
      <p className="mb-4 sm:mb-6 text-amber-900 text-center text-xs sm:text-sm leading-relaxed">
        {source === "form1" 
  ...
  return (
    <div className="bg-beige text-poop font-sans">
      ...
      <section className="text-center px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bangers mb-4 sm:mb-6 text-amber-900">💩 Poo Poo Mountain is Coming!</h1>
      ...
      <section className="px-4 sm:px-6 py-12 sm:py-16 lg:py-20 bg-beige">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bangers text-center mb-12 sm:mb-16 text-amber-900">
            🗓️ The Journey to Poo Poo Mountain
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-amber-900 max-w-4xl mx-auto text-center leading-relaxed">
            通往噗噗山的旅程
          </p>
                  ...
                  <div className="block sm:hidden">
                    <div className="bg-white rounded-lg p-4 shadow-lg">
                      ...
                      <p className="text-poop text-xs leading-relaxed">
                        {index === 0 && "社交媒體意識 - 透過搞笑內容和預覽來建立人氣並聚集我們的糞便隊伍。"}
                        {index === 1 && "眾籌發布 - 是時候支持有史以來最荒謬的紙牌遊戲並解鎖 the stretch goals！"}
                        {index === 2 && "製作與眾籌交付 - 紙牌被印刷，支持者獲得他們的遊戲，混亂開始了！"}
                        {index === 3 && "台灣發布 - 我們的總部將首先獲得零售複製品。當地遊戲商店，準備迎接風暴！"}
                        {index === 4 && "全球發布 - 噗噗山征服世界！隨處有售，線上和線下。"}
                        {index === 5 && "產品合作與擴展包 - 更多的紙牌，更多的混亂，更多的可疑幽默！"}
                      </p>
                    </div>
                  </div>
      ...
      <footer className="bg-poop text-white/80 py-6 sm:py-8 px-4 sm:px-6 text-center">
        <p className="font-bangers text-xl sm:text-2xl mb-2 text-amber-900">💩 Poo Poo Mountain</p>
        <p className="text-sm sm:text-base">The card game that's about to get real messy.</p>
        <p className="text-sm sm:text-base text-amber-900">最臭名昭著的卡牌遊戲。</p>
